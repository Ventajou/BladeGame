...
Ventajou.Demos.SmilingFaceScene = (function() {
    ...
    p.onPaint = function (context) {
        ...
        context.beginPath();
        context.arc(this.get_canvasWidth() / 2, this.get_canvasHeight() / 2, 100, Math.PI * 2, 0, true);
        context.closePath();
        context.fill();
        context.fillStyle = 'black';
        context.beginPath();
        context.arc(this.get_canvasWidth() / 2 - 40, this.get_canvasHeight() / 2 - 30, 10, Math.PI * 2, 0, true);
        context.arc(this.get_canvasWidth() / 2 + 40, this.get_canvasHeight() / 2 - 30, 10, Math.PI * 2, 0, true);
        context.closePath();
        context.fill();
        context.beginPath();
        context.arc(this.get_canvasWidth() / 2, this.get_canvasHeight() / 2 + 30, 40, Math.PI, 0, true);
        context.closePath();
